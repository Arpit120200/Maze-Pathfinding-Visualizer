    ...
    def do_algorithm(self):
        if self.treasure_set:  # Can't find path to null position.
            if self.algorithm == "dfs":
                self.opponent_path = algorithms.dfs(self.maze_grid, self.opponent_start_pos,
                                                self.treasure_pos)
            elif self.algorithm == "bfs":
                self.opponent_path = algorithms.bfs(self.maze_grid, self.opponent_start_pos,
                                                self.treasure_pos)
            elif self.algorithm == "a_star":
                self.opponent_path = algorithms.a_star(self.maze_grid, self.opponent_start_pos,
                                                   self.treasure_pos)
            # Path is found
