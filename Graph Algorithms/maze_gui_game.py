...
class MazeGUI:
    ...
    def calculate_path(self, treasure_pos):
        if self.algorithm == "dfs":
            return algorithms.dfs(self.maze_grid, self.opponent_start_pos, treasure_pos)
        elif self.algorithm == "bfs":
            return algorithms.bfs(self.maze_grid, self.opponent_start_pos, treasure_pos)
        elif self.algorithm == "a_star":
            return algorithms.a_star(self.maze_grid, self.opponent_start_pos, treasure_pos)
        else:
            return None
